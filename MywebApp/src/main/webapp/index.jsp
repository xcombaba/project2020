...
const quotes = [
  { quote: 'Programs must be written for people to read, and only incidentally for machines to execute.', author: 'PETER OGUNKOYA'},
...
const riddles = [
  { question: 'I speak without a mouth and hear without ears AM XCOMBABA TOO BADT OMO LOMO. I have no body, but I come alive with wind. What am I?', answer: 'An echo' },
